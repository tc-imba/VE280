...
struct list_t {
    ...
    list_t(void* l) {
        realList = (opaque_list*)l;
    }

    opaque_list* toPtr() { return realList; }
...
struct tree_t {
    ...
    tree_t(void* l) {
        realTree = (opaque_tree*)l;
    }

    opaque_tree* toPtr() { return realTree; }

    opaque_tree* operator&();
};
